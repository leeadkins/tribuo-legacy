...
class FPDF
    ...
    def TextCenter(y, curtext)
      self.Text((@fw - self.GetStringWidth(curtext))/2,y,curtext)
    end
    
    def TextLeft(y, curtext, leftmargin=10)
      self.Text(leftmargin,y,curtext)
    end
    
    def TextRight(y,curtext, rightmargin=10)
      self.Text(@fw - self.GetStringWidth(curtext) - rightmargin, y, curtext)
    end
    def GetWidth()
      @fw
    end
